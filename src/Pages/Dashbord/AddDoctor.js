...
const AddDoctor = () => {
    ...
    const { data:services,refetch, isLoading} = useQuery('services', ()=> fetch('https://afternoon-bastion-83513.herokuapp.com/services').then(res => res.json()))
    ...
    const onSubmit = async data => {
        ...
        .then(result => {
            if(result.success){
                ...
                // send to database 
                fetch('https://afternoon-bastion-83513.herokuapp.com/doctor', {
                    method: 'POST',
                    headers: {
